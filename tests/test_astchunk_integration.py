...
class MockDocument:
    ...
    def __init__(self, content: str, file_path: str = "", metadata: dict = None):
...
class TestChunkingFunctions:
    ...
    def test_create_traditional_chunks(self):
        ...
        docs = [
            MockDocument("This is a test document. It has multiple sentences. We want to test chunking.")
        ]
    ...
    def test_document_rag_with_ast_chunking(self, temp_code_dir):
        ...
        with tempfile.TemporaryDirectory() as index_dir:
            cmd = [
                ...
                "--index-dir", index_dir,
                "--data-dir", str(temp_code_dir),
                "--enable-code-chunking",
                "--query", "How does the fibonacci function work?",
            ]
